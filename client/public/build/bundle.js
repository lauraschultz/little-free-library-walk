...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div = element("div");
    			attr_dev(input, "class", "rounded px-2 py-1 m-3 border border-gray-300 text-base");
    			add_location(input, file, 86, 0, 2799);
    			attr_dev(div, "class", "h-72 rounded-md my-2");
    			add_location(div, file, 90, 0, 2899);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*zoom, container, center, searchInput, map*/ 59) {
    			 if (zoom) {
    				$$invalidate(3, map = new google.maps.Map(container, { zoom, center }));
    				...
    				map.addListener("bounds_changed", () => {
    					...
    					searchBox.addListener("places_changed", () => {
    						...
    						places.forEach(place => {
    							...
    							$$invalidate(2, selectedPlace = place.geometry.location.toJSON());
    					...
    					map.addListener("click", mapsMouseEvent => {
    						...
    						markers = [];
    						$$invalidate(2, selectedPlace = mapsMouseEvent.latLng.toJSON());
    ...
    class MapBase extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { selectedPlace: 2 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 65, 2, 1914);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$1, 32, 1, 952);
    			attr_dev(p1, "class", "leading-tight");
    			add_location(p1, file$1, 43, 3, 1345);
    			attr_dev(p2, "class", "leading-tight");
    			add_location(p2, file$1, 44, 3, 1391);
    			attr_dev(div2, "class", "flex-initial");
    			add_location(div2, file$1, 42, 2, 1315);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", "5");
    			attr_dev(input, "step", ".25");
    			attr_dev(input, "class", "m-2 flex-1");
    			add_location(input, file$1, 45, 8, 1469);
    			attr_dev(label, "class", "flex items-center ml-2");
    			add_location(label, file$1, 41, 1, 1274);

    			attr_dev(button, "class", button_class_value = "px-2 py-1 w-full mt-4 text-gray-50 rounded " + (/*selectedPlace*/ ctx[0]
    			? "bg-indigo-800"
    			: "bg-gray-300 cursor-pointer"));

    			add_location(button, file$1, 53, 1, 1585);
    			attr_dev(div3, "class", "max-w-2xl rounded-xl bg-gray-50 border border-gray-400 shadow-2xl mx-2 sm:mx-10 md:mx-auto p-4 md:p-6 ");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<ConfigScreen> was created with unknown prop '${key}'`);
    	});
    ...
    class ConfigScreen extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*selectedPlace*/ ctx[0] === undefined && !("selectedPlace" in props)) {
    			console_1$1.warn("<ConfigScreen> was created without expected prop 'selectedPlace'");
    		}

    		if (/*pathToMap*/ ctx[2] === undefined && !("pathToMap" in props)) {
    			console_1$1.warn("<ConfigScreen> was created without expected prop 'pathToMap'");
    		}
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "h-80 rounded-md");
    			add_location(div, file$2, 97, 0, 2309);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const reg_icon = { url: "./assets/marker.png" };
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<ResultsMap> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("waypoints" in $$props) $$invalidate(2, waypoints = $$props.waypoints);
    		if ("selectedLibrary" in $$props) $$invalidate(3, selectedLibrary = $$props.selectedLibrary);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("directionsService" in $$props) $$invalidate(5, directionsService = $$props.directionsService);
    		if ("directionsRenderer" in $$props) $$invalidate(6, directionsRenderer = $$props.directionsRenderer);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*zoom, waypoints, container, center, directionsRenderer, map, directionsService, selectedPlace*/ 503) {
    			 if (zoom) {
    				console.log(waypoints);
    				$$invalidate(4, map = new google.maps.Map(container, { zoom, center }));
    				$$invalidate(5, directionsService = new google.maps.DirectionsService());
    				$$invalidate(6, directionsRenderer = new google.maps.DirectionsRenderer({ suppressMarkers: true }));
    		...
    		if ($$self.$$.dirty & /*selectedLibrary, map*/ 24) {
    			 {
    ...
    class ResultsMap extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*selectedPlace*/ ctx[1] === undefined && !("selectedPlace" in props)) {
    			console_1$2.warn("<ResultsMap> was created without expected prop 'selectedPlace'");
    		}

    		if (/*waypoints*/ ctx[2] === undefined && !("waypoints" in props)) {
    			console_1$2.warn("<ResultsMap> was created without expected prop 'waypoints'");
    		}

    		if (/*selectedLibrary*/ ctx[3] === undefined && !("selectedLibrary" in props)) {
    			console_1$2.warn("<ResultsMap> was created without expected prop 'selectedLibrary'");
    		}
    	}
    ...
    const file$3 = "src/ResultScreen.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*libraries*/ ctx[2].length > 0) return 0;
    		return 1;
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 81, 3, 2331);
    			...
    			add_location(img, file$3, 93, 7, 2823);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	let div0;
    	let h3;
    	let t2_value = (/*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].List_As_Name__c || /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Library_Name__c) + "";
    	let t2;
    	let t3;
    	let p0;
    	let t4_value = /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Street__c + "";
    	let t4;
    	let t5;
    	let p1;
    	let t6_value = (/*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Library_Story__c || "") + "";
    	let t6;
    	let current;
    	...
    	resultsmap = new ResultsMap({
    			props: {
    				...
    				waypoints: /*waypoints*/ ctx[4],
    				selectedLibrary: /*libraryChosen*/ ctx[3]
    				? /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]]
    				: null
    			},
    			$$inline: true
    		});

    	let each_value = /*libraries*/ ctx[2];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*waypoints*/ 16) resultsmap_changes.waypoints = /*waypoints*/ ctx[4];

    			if (dirty & /*libraryChosen, libraries, selectedLibrary*/ 44) resultsmap_changes.selectedLibrary = /*libraryChosen*/ ctx[3]
    			? /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]]
    			: null;

    			resultsmap.$set(resultsmap_changes);

    			if (dirty & /*selectedLibrary, libraryChosen, libraries, letters*/ 108) {
    				each_value = /*libraries*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if ((!current || dirty & /*libraries, selectedLibrary*/ 36) && t2_value !== (t2_value = (/*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].List_As_Name__c || /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Library_Name__c) + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*libraries, selectedLibrary*/ 36) && t4_value !== (t4_value = /*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Street__c + "")) set_data_dev(t4, t4_value);
    			if ((!current || dirty & /*libraries, selectedLibrary*/ 36) && t6_value !== (t6_value = (/*libraries*/ ctx[2][/*selectedLibrary*/ ctx[5]].Library_Story__c || "") + "")) set_data_dev(t6, t6_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:2) {#if libraries.length > 0}",
    		ctx
    	});
    ...
    // (56:5) {#each libraries as lib, i}
    function create_each_block(ctx) {
    	let li;
    	let span;
    	let t0_value = /*letters*/ ctx[6][/*i*/ ctx[11]] + "";
    	let t0;
    	let t1;
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[7](/*i*/ ctx[11]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 62, 7, 1590);

    			attr_dev(li, "class", li_class_value = "cursor-pointer leading-none pl-2 py-2 overflow-hidden overflow-ellipsis whitespace-nowrap text-sm " + (/*selectedLibrary*/ ctx[5] === /*i*/ ctx[11]
    			? "bg-gray-50 shadow rounded-l"
    			: "shadow-inner"));

    			add_location(li, file$3, 56, 6, 1293);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*libraries*/ 4 && t2_value !== (t2_value = (/*lib*/ ctx[9].List_As_Name__c || /*lib*/ ctx[9].Library_Name__c) + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*selectedLibrary*/ 32 && li_class_value !== (li_class_value = "cursor-pointer leading-none pl-2 py-2 overflow-hidden overflow-ellipsis whitespace-nowrap text-sm " + (/*selectedLibrary*/ ctx[5] === /*i*/ ctx[11]
    			? "bg-gray-50 shadow rounded-l"
    			: "shadow-inner"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:5) {#each libraries as lib, i}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("Go\n\t\tback");
    			attr_dev(div0, "class", "max-w-2xl rounded-xl bg-gray-50 border border-gray-400 shadow-2xl mx-2 sm:mx-10 md:mx-auto p-4 md:p-6 ");
    			add_location(div0, file$3, 42, 0, 715);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const click_handler = i => {
    		$$invalidate(5, selectedLibrary = i);
    		$$invalidate(3, libraryChosen = true);
    	};

    	const click_handler_1 = () => $$invalidate(0, showConfig = true);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("showConfig" in $$props) $$invalidate(0, showConfig = $$props.showConfig);
    		if ("libraries" in $$props) $$invalidate(2, libraries = $$props.libraries);
    		if ("libraryChosen" in $$props) $$invalidate(3, libraryChosen = $$props.libraryChosen);
    		if ("waypoints" in $$props) $$invalidate(4, waypoints = $$props.waypoints);
    		if ("selectedLibrary" in $$props) $$invalidate(5, selectedLibrary = $$props.selectedLibrary);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*libraries*/ 4) {
    			 {
    				if (libraries) {
    					$$invalidate(4, waypoints = libraries.map(r => {
    ...
    class ResultScreen extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*showConfig*/ ctx[0] === undefined && !("showConfig" in props)) {
    			console.warn("<ResultScreen> was created without expected prop 'showConfig'");
    		}

    		if (/*libraries*/ ctx[2] === undefined && !("libraries" in props)) {
    ...
    function create_else_block$1(ctx) {
    	...
    	function resultscreen_showConfig_binding(value) {
    		/*resultscreen_showConfig_binding*/ ctx[6].call(null, value);
    	}

    	let resultscreen_props = {
    		selectedPlace: /*selectedPlace*/ ctx[1],
    		libraries: /*libraries*/ ctx[2]
    	};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*selectedPlace*/ 2) resultscreen_changes.selectedPlace = /*selectedPlace*/ ctx[1];
    			if (dirty & /*libraries*/ 4) resultscreen_changes.libraries = /*libraries*/ ctx[2];
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(script, file$4, 19, 1, 688);
    			...
    			add_location(img, file$4, 28, 2, 1143);
    			attr_dev(nav, "class", "max-w-2xl mx-2 sm:mx-10 md:mx-auto");
    			add_location(nav, file$4, 27, 1, 1092);
    			...
    			add_location(header, file$4, 25, 0, 971);
    			...
    			add_location(footer, file$4, 38, 0, 1442);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	// import type { env } from "{"env":{"GOOGLE_API_KEY":"AIzaSyA0ZY7KS7fMUyP05gzBWAjNWAjPU3pK3yw","SERVER":"https://lfl-walk.herokuapp.com"}}";
    	let selectedPlace;
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { mapReady: 0 });
