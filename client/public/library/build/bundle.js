...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 89, 0, 2875);
    			...
    			add_location(path, file, 103, 2, 3270);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let searchInput;
    	let mapLoaded = false;
    	const icon = { url: "library/assets/marker_star.png" };
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "d", "M0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0V2C14.4183 2 18 5.58172 18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10H0Z");
    			attr_dev(path, "fill", "#374151");
    			add_location(path, file$2, 108, 2, 2617);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "0 0 20 20");
    			...
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$2, 101, 1, 2452);
    			attr_dev(div, "class", "h-80 rounded-md my-2 flex items-center justify-center bg-gray-200");
    			add_location(div, file$2, 98, 0, 2347);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let container;
    	let mapLoaded = false;
    	const star_icon = { url: "library/assets/marker_star.png" };
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*zoom, waypoints, container, center, directionsRenderer, map, directionsService, selectedPlace*/ 1005) {
    			 if (zoom) {
    ...
    /* src/Footsteps.svelte generated by Svelte v3.30.0 */

    const file$3 = "src/Footsteps.svelte";
    ...
    function instance$3($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Footsteps", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Footsteps> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Footsteps extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_else_block_1(ctx) {
    	...
    	let footsteps;
    	let current;
    	footsteps = new Footsteps({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 105, 2, 3121);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			attr_dev(p, "class", "font-bold text-lg text-center");
    			add_location(p, file$4, 87, 3, 2474);
    			if (img.src !== (img_src_value = "library/assets/person_with_map.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "max-w-md mx-auto my-4 w-full");
    			attr_dev(img, "alt", "woman holding a map");
    			add_location(img, file$4, 99, 7, 2978);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 68, 7, 1733);
    			...
    			add_location(li, file$4, 62, 6, 1436);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$4, 109, 0, 3222);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "library/assets/logo.svg")) attr_dev(img, "src", img_src_value);
    			...
    			add_location(main, file$5, 34, 0, 1252);
    			...
    			add_location(a, file$5, 42, 1, 1524);
    			attr_dev(footer, "class", "flex-initial bg-gray-700 text-gray-50 mt-5");
    			add_location(footer, file$5, 41, 0, 1463);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
