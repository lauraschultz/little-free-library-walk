export const libs: Promise<Library[]> = new Promise((resolve, _) =>
	resolve([
		{
		...
		},
		{
			...
			Library_Story__c:
				"This is dedicated to Rosemary Murphy who portrayed Maudie Atkinson in To Kill A Mockingbird which was one of the greatest books of all time. I dedicate this Little Free Library to her.",
			Exact_Location_on_Map__c: true,
			Email_on_Map__c: false,
		...
		},
		{
			...
			Library_Story__c:
				"This library is one of 20 donated to Little Brothers-Friends of the Elderly.",
			Exact_Location_on_Map__c: true,
			Email_on_Map__c: false,
		...
		},
		{
			...
			Library_Story__c:
				"Episcopal Homes is the proud owner of a Little Free Library, located by Coventry Chapel's Meditation Garden and the Transitional Care Unit (TCU) Entrance! We hope you will â??take a book, return a bookâ?? when you visit your friends and loved ones. We are initially focusing on books that encourage a spirit of Wellness and Volunteerism. Our library is the result of an effort between AARP MNï»¿, Little Brothers - Friends of the Elderly, and Little Free Libraryï»¿ to reduce loneliness and isolation among older adults.",
			Exact_Location_on_Map__c: true,
			Email_on_Map__c: true,
		...
		},
		{
			...
			Library_Story__c:
				"Built this as an eighth wedding anniversary present for my Little Free Library loving wife. After being a recipient and benefactor of many books from other in the area, now she can give back.",
			Exact_Location_on_Map__c: true,
			Email_on_Map__c: false,
		...
		},
		{
			...
			Library_Story__c:
				"The library has enhanced an already close knit- connected neighborhood. Lots of participation since erected in late July! Loving it.",
		...
		},
		{
			...
			Library_Story__c:
				"I was leaving my house when a car drove by slowly. The woman in the car said she was researching a Minnesota children's author named Emma Brock who had lived in our building in the early 20th century. She was doing research to write a scholarly article about her.\n" +
		...
		},
		{
			...
			Library_Story__c:
				"We built the library as a family for two reasons:\n" +
		...
		},
		{
			...
			Library_Story__c:
				"My three sons surprised me on my 80th birthday by building my Little Free Library -- an accurate replica of the Olson family home in St. Paul where we lived for 50 years until we sold it last year. Although my new home faces Mississippi River Boulevard, parking there is forbidden, so we have placed the LFL at the back of the property facing Otis Avenue.  Come, see, enjoy a book!",
			Exact_Location_on_Map__c: true,
			Email_on_Map__c: false,
